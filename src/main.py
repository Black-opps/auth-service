...
from .api import auth, keys, mfa, sessions, sso, tokens  # the routers
from .core.config import settings
from .core.database import Base, SessionLocal, engine, redis_client
from .core.exceptions import AuthException
from .middleware.rate_limit import (  # assuming this is where RateLimitMiddleware lives
    RateLimitMiddleware,
)
...
request_duration = Histogram(
    "auth_service_request_duration_seconds", "Request duration", ["method", "endpoint"]
)
